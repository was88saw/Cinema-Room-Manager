    ...
    public static void determineWhoIsWho(Employee[] employees) {
        for (Employee employee : employees) {
            if(employee instanceof Employee){
                if (employee.getClass().equals(Employee.class)){System.out.println("EMP");}
                if (employee.getClass().equals(Developer.class)){System.out.println("DEV");}
                if (employee.getClass().equals(DataAnalyst.class)){System.out.println("DA");}
            }
        }
    }
}
